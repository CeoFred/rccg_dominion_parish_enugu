...
<head>
	...
	<title>Adults Forum - RCCG Dominion Parish Enugu Province 2 </title>
		  <meta name="description" content="Welcome to the Adults forum, start now to explore great topics with unlimited contents." />
...
<form class="md-form form-control" action="adults-forum" method="post">
	<input type="text" class="form-control" name="topic" placeholder="Topic" v>
