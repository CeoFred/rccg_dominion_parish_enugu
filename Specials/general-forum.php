...
<html>
<head>
	<title>General Forum - RCCG Dominion Parish Enugu Province 2 </title>
		  <meta name="description" content="Welcome to the General forum, start now to explore great topics with unlimited contents." />
...
<div class="container-fluid" style="margin-top: 100px;">
	<div class="row">
		<div class="col-md-12" style="border-left: 5px solid lightblue;">
			<div align="center">
			...
			<button class="btn btn-secondary">Add Topic</button>
		
<div id="p" style="display: none;">
<form class="md-form form-control" action="general-forum" method="post">
	...
	<input type="submit" class="btn btn-success" name="add-topic" value="Submit Topic">
        ...
        <?php   
          ...
          while ($r = mysqli_fetch_assoc($res)) {
          	$f_type = 'General Forum';
        ?>
<div class="" style="border-botom:2px solid black;">
	<div style="font-size: 20px;text-transform: uppercase;color: black;"><b><u style="text-transform: uppercase;color: black;"><a href="read-topic?topic=<?php echo $r['topic']; ?>&posttime=<?php echo $r['added_on'] ?>
...
<?php } ?>
		...
		<div class="col-md-12" style="margin-top: 30px;display: inline-block;">
