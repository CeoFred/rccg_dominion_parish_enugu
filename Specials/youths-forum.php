...
<html>
<head>
	<title>Youths Forum - RCCG Dominion Parish Enugu Province 2 </title>
		  <meta name="description" content="Welcome to the Youths forum, start now to explore great topics with unlimited contents." />
...
<?php   
	...
	&topic_id=<?php echo $r['topic_hash'] ?>&added_by=<?php echo $r['added_by']?>""><?php echo $r['topic'] ?>
...
<form class="md-form form-control" action="youths-forum" method="post">
...
<div class="tab" style="border-botom:2px solid black;">
	<div style="text-transform: uppercase;font-size: 20px;color: black;"><b><u><a href="read-topic?topic=<?php echo $r['topic']; ?>&posttime=<?php echo $r['added_on'] ?>
